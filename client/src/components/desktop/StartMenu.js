...
const StartMenu = ({ isOpen, onClose, onLaunchApp }) => {
  ...
  const menuItems = [
    ...
    { icon: FaBrain, text: 'Neural Network', id: 'neural-network', requiresWallet: true },
    { icon: FaNetworkWired, text: 'SPL Tracker', id: 'network', description: 'View and manage promoted tokens' },
    { icon: FaTicketAlt, text: 'Solana Raffle', id: 'solana-raffle', requiresWallet: true, description: 'Enter into our raffle and have the chance to win big prizes paid out in Solana!' },
    { icon: FaWallet, text: 'My Wallet', id: 'wallet', requiresWallet: true, description: 'My wallet allows users to check their balances which track $AIS, Solana and how many raffle tickets they own and what number(s) they have.' },
